...
<main>
    <div class="search_bar" style="position: relative;">
        <input type="text" id="searchInput" placeholder="Recherchez une annonce, une catégorie, une célébrité..." autocomplete="off">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function initTimers() {
            document.querySelectorAll('.timer').forEach(el => {
                ...
                if (endDate && typeof startCountdown === 'function') startCountdown(endDate, el);
            });
        }
        initTimers();
        ...
        searchInput.addEventListener('input', async function () {
            ...
            try {
                ...
                results.forEach(item => {
                    ...
                    if (item.type === 'category') typeText = 'catégorie';
        ...
        function renderProductGrid(productsList) {
            ...
            productsList.forEach(p => {
                ...
                card.innerHTML = `
                    <div class="card-img-container">
                        <img src="${encodeURI(imgUrl)}" alt="Image annonce">
                    </div>
                    <div class="card-body">
                        <h3>${secureTitle}</h3>
                        ...
                        <div class="action-row">
                            ...
                            <a class="bid-btn" href="index.php?action=product&id=${parseInt(productId, 10)}">Enchérir</a>
                        </div>
                    </div>
                `;
